package com.yuand.smarteye.purchase.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.yuand.common.constant.PurchaseConstant;
import com.yuand.common.to.LowWarnCountTo;
import com.yuand.common.utils.ChangeList;
import com.yuand.common.utils.PageUtils;
import com.yuand.common.utils.Query;
import com.yuand.common.utils.R;
import com.yuand.smarteye.purchase.dao.BuyDemandDao;
import com.yuand.smarteye.purchase.dao.BuyListDao;
import com.yuand.smarteye.purchase.entity.BuyDemandEntity;
import com.yuand.smarteye.purchase.entity.BuyListEntity;
import com.yuand.smarteye.purchase.feign.WareStockFeign;
import com.yuand.smarteye.purchase.service.BuyDemandService;
...
public class BuyDemandServiceImpl extends ServiceImpl<BuyDemandDao, BuyDemandEntity> implements BuyDemandService {
    ...
    public List<WarnEntityInfoVo> autoRemand() {
        ...
        while (iterator.hasNext()) {
            ...
            if (buyDemandEntities == null || buyDemandEntities.isEmpty()) { //如果该货物存在（新建、采购中、已分配）状态的采购需求，则不必重复自动创建该货物的采购需求
